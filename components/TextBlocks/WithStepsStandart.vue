...
.digits-row {
  ...
  &__item {
    ...
    @media (max-width: 767px) {
      ...
      margin: 0 auto;
      gap: 1.2rem;
      padding: 1.2rem 1.2rem 6.8rem;
    }

    &::before {
      counter-increment: digitRow;
      content: counter(digitRow);
      width: 65px;
      height: 65px;
      border-radius: 50%;
